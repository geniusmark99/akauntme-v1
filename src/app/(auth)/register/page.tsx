...
const Register = () => {
    return (
        <div className='h-auto lg:h-[100dvh]'>
            <div className='flex flex-col lg:flex-row-reverse w-full '>
                ...
                <div className=' lg:w-6/12 flex flex-col overflow-hidden relative  justify-center items-center bg-gradient-to-r from-indigo-600 via-akauntme to-blue-600 p-10'>
                            ...
                            <form action="#" className='flex flex-col gap-y-4 items-center w-full'>
                                <div className='flex gap-y-1 flex-col w-full lg:min-w-[350px] relative'>
                                    ...
                                    <div className='flex items-center relative'>
                                        <div className='absolute inset-3 top-2 size-9 flex justify-center items-center'>
                                            <svg className='size-6 fill-white/80' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" >
                                        ...
                                        <input type="text" id='fullname' autoComplete='none' placeholder='John doe' className='indent-3 border-2 w-full outline-none hover:border-white/40 focus:border-white/40 focus:outline-none focus:ring-0 bg-transparent text-white border-white/20 placeholder:text-white/60 py-3 px-10 rounded-xl' />
                                    </div>
                                </div>
                                ...
                                <div className='flex gap-y-1 flex-col w-full lg:min-w-[300px] relative'>
                                    ...
                                    <div className='flex items-center relative'>
                                        <div className='absolute inset-3 top-2 size-9 flex justify-center items-center'>
                                            <svg className='size-6 fill-white/80' viewBox="0 0 48 48" >
                                        ...
                                        <input type="email" id='email' autoComplete='off' placeholder='youremail.com@gmail.com' className='indent-3 border-2 w-full outline-none hover:border-white/40 focus:border-white/40 focus:outline-none focus:ring-0 bg-transparent text-white border-white/20 placeholder:text-white/60 py-3 px-10 rounded-xl' />
                                    </div>
                                ...
                                <div className='flex gap-y-1 flex-col w-full lg:min-w-[300px] relative'>
                                    ...
                                    <div className='flex items-center relative'>
                                        ...
                                        <input type="text" id='business_type' autoComplete='none' placeholder='Retailer' className='indent-3 border-2 w-full outline-none hover:border-white/40 focus:border-white/40 focus:outline-none focus:ring-0 bg-transparent text-white border-white/20 placeholder:text-white/60 py-3 px-10 rounded-xl' />
                                    </div>
                                </div>

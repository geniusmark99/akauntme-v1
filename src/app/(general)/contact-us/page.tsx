            ...
            <div className='pt-20'>
                <div className="h-auto bg-blue-50 flex flex-col md:flex-row">
                    <div className="p-4 lg:p-20 w-full md:w-6/12">
                        ...
                        <p className="mt-6">
                            We can give you a demo, help you choose the best plan, or create a personalized package to help your organization get the most out of Akauntme.
                        </p>
                        <ul className="flex flex-col gap-y-2 lg:gap-y-5 mt-6 lg:mt-10">
                            <li className="flex items-center gap-x-2">
                                ...
                                Customize a bookkeeping plan tailored to your business needs.
                            </li>
                            ...
                            <li className="flex items-center gap-x-2">
                                ...
                                Learn how to track sales, expenses, inventory, and more — all in one place.
                            </li>
                            <li className="flex items-center gap-x-2">
                                <svg className="size-4 fill-gray-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" >
                                    <path d="M14.5 2.792969L5.5 11.792969L1.851563 8.148438L1.5 7.792969L0.792969 8.5L1.148438 8.851563L5.5 13.207031L15.207031 3.5Z" />
                                </svg>
                                Explore staff roles, backups, and financial insights for your business growth.
                            </li>
                            ...
                            <li className="flex items-center gap-x-2">
                                ...
                                Secure your data with our double layer encryption system.
                            </li>

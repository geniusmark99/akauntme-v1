                    ...
                    <header className={` ${isExpanded ? 'w-full lg:w-[86%]' : 'w-full lg:w-[95%]'}  flex justify-between items-center border-b top-0 z-[2000] border-gray-100 dark:border-zinc-600 px-5 py-2 lg:py-3.5 fixed bg-white dark:bg-zinc-900`}>
                        <div className="flex lg:hidden w-[10%] relative">
                            <button
                                ...
                                className="p-2 text-white bg-gradient-to-tr from-akauntme to-blue-500 dark:bg-zinc-700 rounded-md focus:outline-none"
                            >
                                {isOpen ?
                        ...
                        <motion.div
                            ...
                            className="absolute top-14 left-0 right-0 mt-2 bg-white dark:bg-zinc-800 shadow-md overflow-hidden lg:hidden z-[3000]"
                        >
                                ...
                                <AnimatePresence>
                                    {isProfile && (
                                        <motion.div
                                            ...
                                            className="absolute mt-2 w-60 right-2 z-50 origin-top-right bg-white dark:bg-zinc-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg"
                                        >
                                ...
                                <AnimatePresence>
                                    {isNotification && (
                                        <motion.div
                                            ...
                                            exit={{ opacity: 0, y: -10 }}
                                            transition={{ duration: 0.2 }}
                                            className="absolute mt-2 w-[260px] md:w-[320px] p-2 lg:w-[400px] right-2 z-50 origin-top-right bg-white dark:bg-zinc-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg"
                                        >
                                            <h1>Notification</h1>
                                            {/* <div className="py-2 text-sm text-gray-700 dark:text-zinc-100 space-y-2">

                                    ...
                                    {isProfile && (
                                        ...
                                        >
                                            <div className="py-2 text-sm text-gray-700 dark:text-zinc-100 space-y-2">
                                                ...
                                                <div className="font-semibold text-sm  px-4 py-2 mx-2">
                                                    {user?.name}
                                                </div>

                                                <Link href="/profile" className="block px-4 py-2 mx-2 rounded-lg hover:bg-gray-100 dark:hover:bg-zinc-700">
                                                    <div className="flex items-center gap-x-2">
                                                ...
                                                <Link href="/settings" className="block px-4 py-2 mx-2 rounded-lg hover:bg-gray-100 dark:hover:bg-zinc-700">
                                                    <div className="flex items-center gap-x-2">
                                                        <svg className="size-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" >
                                                ...
                                                <Link href="/help" className="block px-4 py-2 mx-2 rounded-lg hover:bg-gray-100 dark:hover:bg-zinc-700">
                                                    <div className="flex items-center gap-x-2">
                                                        <svg className="size-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" >
